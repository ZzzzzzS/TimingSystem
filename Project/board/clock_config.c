...
#define SIM_TPM_CLK_SEL_MCGFLLCLK_CLK                     1U  /*!< TPM clock select: MCGFLLCLK output clock */
#define SIM_UART_CLK_SEL_MCGFLLCLK_CLK                    1U  /*!< UART clock select: MCGFLLCLK output clock */
...
- {id: COPCLK.outFreq, value: 20.97152 MHz}
...
- {id: MCGFLLCLK.outFreq, value: 41.94304 MHz}
- {id: MCGIRCLK.outFreq, value: 4 MHz}
- {id: OSCERCLK.outFreq, value: 32.768 kHz}
- {id: System_clock.outFreq, value: 41.94304 MHz}
- {id: TPMCLK.outFreq, value: 41.94304 MHz}
- {id: UART0CLK.outFreq, value: 41.94304 MHz}
settings:
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_SetLpsci0Clock(SIM_UART_CLK_SEL_MCGFLLCLK_CLK);
